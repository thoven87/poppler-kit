...
// CPopplerCore (pkg-config "poppler") adds -I.../include/poppler to the search
// path on both macOS (Homebrew) and Linux (cmake source build), so these
// bare-name includes resolve without any platform guards.
#include <PDFDoc.h>
#include <OutputDev.h>
#include <GfxState.h>
